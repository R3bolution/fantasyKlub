  ...
  return (
    <View style={styles.container}>
      <View style={styles.field}>
        <View style={[styles.player, styles.player1]}><Text style={[styles.playerText]}>Jugador 1</Text></View>
        <View style={[styles.player, styles.player2]}><Text style={[styles.playerText]}>Jugador 2</Text></View>
        <View style={[styles.player, styles.player3]}><Text style={[styles.playerText]}>Jugador 3</Text></View>
      </View>
    </View>
  );
}
